...
def generate_launch_description():
    ...
    description_file = "/manipulator_simulator/src/ur5e_simulator/urdf/ur5e_rgbd.xacro"
    world_file = "/manipulator_simulator/src/ur5e_simulator/sim_env/camera_world.sdf"
